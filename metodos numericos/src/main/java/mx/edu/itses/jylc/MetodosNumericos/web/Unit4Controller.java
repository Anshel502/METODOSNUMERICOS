...
import mx.edu.itses.jylc.MetodosNumericos.services.UnidadIVService;
...
public class Unit4Controller {
    ...
    public String formDDNewton(Model model) {
        model.addAttribute("modelDDN", new DDNewtony());
        return "unit4/ddnewton/formddnewton";
    }

    @PostMapping("/unit4/solveddnewton")
    public String solveDDNewton(DDNewtony modelDDN, Errors errors, Model model) {
